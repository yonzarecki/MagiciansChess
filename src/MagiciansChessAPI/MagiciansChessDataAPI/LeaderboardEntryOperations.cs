...
namespace MagiciansChessAPI
{
    ...
    /// </summary>
    public partial class LeaderboardEntryOperations : IServiceOperations<MagiciansChessDataAPI>, ILeaderboardEntryOperations
    {
        /// <summary>
        /// Initializes a new instance of the LeaderboardEntryOperations class.
        /// </summary>
        /// <param name='client'>
        /// Reference to the service client.
        /// </param>
        public LeaderboardEntryOperations(MagiciansChessDataAPI client)
        {
            if (client == null) 
            {
        ...
        /// <summary>
        /// Gets a reference to the MagiciansChessDataAPI
        /// </summary>
        ...
        /// </return>
        public async Task<HttpOperationResponse<IList<LeaderboardEntry>>> GetWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Tracing
        ...
        public async Task<HttpOperationResponse<LeaderboardEntry>> GetByIdWithHttpMessagesAsync(string username, int id, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new HttpOperationResponse<LeaderboardEntry>();
            _result.Request = _httpRequest;
            _result.Response = _httpResponse;
            // Deserialize Response
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = SafeJsonConvert.DeserializeObject<LeaderboardEntry>(_responseContent, this.Client.DeserializationSettings);
                }
                catch (JsonException ex)
                {
                    _httpRequest.Dispose();
