...
namespace MagiciansChessApp
{
    ...
    /// ChessAI operations.
    /// </summary>
    public partial class ChessAI : IServiceOperations<MagiciansChessAPI>, IChessAI
    {
        /// <summary>
        /// Initializes a new instance of the ChessAI class.
        /// </summary>
        /// <param name='client'>
        /// Reference to the service client.
        /// </param>
        public ChessAI(MagiciansChessAPI client)
        {
            if (client == null) 
            {
